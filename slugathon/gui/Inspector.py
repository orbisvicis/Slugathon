...
class Inspector(Gtk.EventBox):
    ...
    def __init__(self, playername):
        ...
        self.vbox.pack_start(self.legion_name, expand=True, fill=True, padding=0)

        hbox = Gtk.HBox(spacing=3)
        self.vbox.pack_start(hbox, expand=True, fill=True, padding=0)

        self.marker_hbox = Gtk.HBox(spacing=3)
        hbox.pack_start(self.marker_hbox, expand=False, fill=True, padding=0)
        self.chits_hbox = Gtk.HBox(spacing=3)
        hbox.pack_start(self.chits_hbox, expand=True, fill=True, padding=0)
    ...
    def show_legion(self, legion):
        ...
        self.marker_hbox.pack_start(self.marker.event_box, expand=False, fill=True, padding=0)
        ...
        for creature in legion.sorted_living_creatures:
            ...
            self.chits_hbox.pack_start(chit.event_box, expand=False, fill=True, padding=0)
        ...
        for tup in tuples:
            if len(tup) == 2 and tup[1] != 0:
                ...
                if count >= 2:
                    ...
                    self.chits_hbox.pack_start(label, expand=False, fill=True, padding=0)
